    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen gap-10 p-10 bg-slate-950 text-white">
            <div>
                ...
                <motion.div 
                    className="flex grid lg:grid-cols-2 md-grid-cols-2 sm:grid-cols-1"
            ...
            {/* Conditionally render when more is true */}
            {more && (
                <>
                    <motion.div
                    ...
                    <motion.div
                        className="flex flex-wrap justify-center gap-10 pt-10 grid lg:grid-cols-3 md-grid-cols-2 sm:grid-cols-1"
                        initial={{ opacity: 0, x: "blur(10px)" }}
                        whileInView={{ opacity: 1, filter: "blur(0px)" }}
                        transition={{ duration: 0.8, ease: "easeOut" }}
                    >
                        {gameDev[4].map((gameItem, index) => (
                            <div key={gameItem.name}>
                                ...
                                <motion.div
                                    initial={{ opacity: 0, y: 100, x: -50 ,filter: "blur(10px)" }}
                                    whileInView={{ opacity: 1, y: 0, x: 0 ,filter: "blur(0px)" }}
                                    viewport={{ once: true }}
                                    transition={{ duration: 0.8 + (index % 3) * 0.2, ease: "easeOut" }}
                                    className="p-1 border-4 border-gray-800 rounded-lg bg-white"
                                >
